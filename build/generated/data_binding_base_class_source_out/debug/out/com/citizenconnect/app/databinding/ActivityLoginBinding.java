...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      @NonNull CardView cardForm, @NonNull CardView cardLogo, @NonNull TextInputEditText etEmail,
      ...
      @NonNull TextView tvSignup, @NonNull View vh) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, cardForm, cardLogo, etEmail,
          etPassword, progressBar, tilEmail, tilPassword, tvSignup, vh);
    }
